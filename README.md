# Freelancer
1. Realizar un [**fork**](https://gist.github.com/ivandevp/1de47ae69a5e139a6622d78c882e1f74) del repositorio en github.
2. Luego **clonar** el fork en la máquina. Recordar que el comando a usar es `git clone` y su estructura normalmente se ve así:
```bash
...
* Existe un archivo base `index.html` en el cual deberás escribir la
...
* Los íconos de redes sociales obtenerlos de [Font Awesome](http://fontawesome.io/).
